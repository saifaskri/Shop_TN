...
class EasyAdminSubscriber implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return[
            ...
            BeforeEntityPersistedEvent::class=>['setStatus'],
        ];
    }
    ...
    {
        $entityInstance = $event->getEntityInstance();
        if (!(($entityInstance instanceof Products)||($entityInstance instanceof Categorys)))return;
        if(!$entityInstance->isStatus())$entityInstance->setStatus(0);
    }
